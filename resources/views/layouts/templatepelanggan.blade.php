        ...
        <div class="sidebar-content">
          <div class="nav-container">
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
               <li class="nav-item"><a href="{{route('pelanggan.dashboard', Session::get('id_meja'))}}"><i class="icon-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a>
              </li>
               <li class="nav-item"><a href="{{route('pelanggan_order.index')}}"><i class="icon-book-open"></i><span data-i18n="" class="menu-title">Order</span></a>
              </li>

...
<form action="{{route('masakan.update',$data)}}" method="post" enctype="multipart/form-data" >
@csrf
@method('PATCH')
@if(session('pesan'))
          ...
          <div class="card-block">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="masakan" required autofocus value="{{$data['masakan']}}">
              </div>
              <div class="form-group">
